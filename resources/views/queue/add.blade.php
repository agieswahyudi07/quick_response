                        ...
                        <div class="card-body mt-3">
                            ...
                            <form class="row g-3" method="POST" action="{{ route('queue.store') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="txtComplaintName" name="txtComplaintName"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="time" class="form-control" id="txtComplaintTime" name="txtComplaintTime"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="txtComplaintDate" name="txtComplaintDate"
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="selPriority"
                                            ...
                                            @foreach ($data['priority'] as $priority)
                                                <option value="{{ $priority->priority_id }}">
                                                    {{ $priority->priority_code . '-' . $priority->priority_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" id="txtComplaintDesc"
                                            name="txtComplaintDesc">{{ old('txtComplaintDesc', Session::get('txtComplaintDesc')) }}</textarea>
                                    </div>
                                </div>
