...
<head>
  ...
  <title>Dashboard - Quick Response</title>
  ...
  <link href="{{ asset('assets/img/alhasra.png') }}" rel="apple-touch-icon">
  ...
  * Template URL: https://bootstrapmade.com/nice-admin-bootstrap-user-html-template/
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ asset('assets/img/alhasra.png') }}" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-link collapsed">
            <a class="nav-item" href="{{ route('user.complaint') }}">
        ...
        <li class="nav-link collapsed">
            <a class="nav-item" href="{{ route('user.queue') }}">
                <i class="bi bi-card-list"></i>
                <span>Queue</span>
            </a>
        </li>
        ...
        <li class="nav-link collapsed">
            <a class="nav-item" href="{{ route('user.progress') }}">
        ...
        <li class="nav-link collapsed">
            <a class="nav-item" href="{{ route('user.completed') }}">
        ...
        <li class="nav-link collapsed">
            <a class="nav-item" href="{{ route('user.hold') }}">
                <i class="bi bi-grid"></i>
                <span>Hold</span>
            </a>
        </li>
 ...
 @yield('main')
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Quick Response</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
