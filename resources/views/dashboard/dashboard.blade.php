          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  <a class="icon" href="{{ route('queue') }}  "><i class="bi bi-eye"></i></a>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card customers-card">
                ...
                <div class="filter">
                  <a class="icon" href="{{ route('progress') }}  "><i class="bi bi-eye"></i></a>
                </div>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="filter">
                  <a class="icon" href="{{ route('completed') }}  "><i class="bi bi-eye"></i></a>
                </div>
