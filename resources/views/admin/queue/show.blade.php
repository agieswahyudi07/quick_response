            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endswitch
                        ...
                        @if ($data['complaint']->complaint_progress_date)
                            <p class="card-text text-left">
                                <strong>Progress Date :</strong> {{ $data['complaint']->complaint_progress_date }}<br>
                            </p>
                        @endif
                        @if ($data['complaint']->complaint_completed_date)
                            <p class="card-text text-left">
                                <strong>Completed Date :</strong> {{ $data['complaint']->complaint_completed_date }}<br>
                            </p>
                        @endif
                        <a href="{{ route('admin.queue') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">
