                ...
                <div class="col-lg-12 ">
                    <div class="card">
                        <div class="card-body mt-3">
                            ...
                            <form id="formNeed" name="formHold" class="row g-3" method="POST"
                                action="{{ route('admin.need.store') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary" id="submitNeed"
                                            name="submitNeed">Submit Form</button>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#formNeed').validate({
                ...
                submitHandler: function(form) {
                    $('#submitNeed').prop('disabled', true).val('Processing...');
                    form.submit();
                }
            });
