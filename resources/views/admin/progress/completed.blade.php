            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="card-body mt-3">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.progress.completed.store') }}">
                            @csrf
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" id="selComplaint" name="selComplaint">
                                        ...
                                        @foreach ($data['complaints'] as $complaint)
                                            <option value="{{ $complaint->complaint_id }}" {{ $complaint->complaint_id == $data['complaint_id'] ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtTroubleCause" name="txtTroubleCause" value="{{ Session::get('txtTroubleCause') }}">
                            </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtTroubleSolution" name="txtTroubleSolution" value="{{ Session::get('txtTroubleSolution') }}">
                            </div>
                            </div>
