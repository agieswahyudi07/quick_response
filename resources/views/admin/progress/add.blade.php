                ...
                <div class="col-lg-12 ">
                    <div class="card">
                        <div class="card-body mt-3">
                            ...
                            <form id="formHold" name="formHold" class="row g-3" method="POST"
                                action="{{ route('admin.progress.hold.store') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="txtNeedName" name="txtNeedName"
                                            value="{{ Session::get('txtNeedName') }}">
                                        <div class="invalid-feedback"></div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="txtNeedQty" name="txtNeedQty"
                                            value="{{ Session::get('txtNeedQty') }}">
                                        <div class="invalid-feedback"></div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="txtNeedPrice" name="txtNeedPrice"
                                            value="{{ Session::get('txtNeedPrice') }}">
                                        <div class="invalid-feedback"></div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary" id="submitHold"
                                            name="submitHold">Submit Form</button>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#formHold').validate({
                ...
                submitHandler: function(form) {
                    $('#submitHold').prop('disabled', true).val('Processing...');
                    form.submit();
                }
            });
